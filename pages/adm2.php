        ...
        <section class="content">
            ...
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                            <img src="../img/icon_user.png" alt="Icon Usuário" style="width: 50px; margin-bottom: 15px;">
                            <th>Nome</th>
                            <img src="../img/email.png" alt="Icon Email" style="width: 50px; margin-bottom: 15px;">
                            <th>Email</th>
                            <img src="../img/sacola_compras.png" alt="Icon Carrinho" style="width: 50px; margin-bottom: 15px;">
                            <th>Compras</th
                            <th>Ações</th>
                        </tr>
                    </thead>
