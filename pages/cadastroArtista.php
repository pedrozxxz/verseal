...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["cadastro"])) {
        ...
        if ($senha !== $confirmar) {
            ...
            // INSERT atualizado incluindo nome_artistico e insta
            $sql = "INSERT INTO usuarios (nome, nome_artistico, insta, email, telefone, senha) VALUES (?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssssss", $nome, $nome_artistico, $insta, $email, $telefone, $senhaHash);
                ...
                echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            Swal.fire({
                                ...
                                " . ($fromCheckout ? "window.location.href = 'checkout.php';" : "window.location.href = 'artistahome.php';") . "
                            });
                        });
                    </script>";
            } else {
