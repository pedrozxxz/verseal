...
<head>
    ...
    <title>Novo Artista - Verseal</title>
    ...
    <div class="form-container">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" id="nome" placeholder="Digite o nome do artista">
            ...
            <div class="form-group">
                <label for="obras">Quantidade de Obras</label>
                <input type="number" id="obras" placeholder="Número de obras">
                <i class="fas fa-palette"></i>
            </div>
            <button type="button" class="save-btn" onclick="window.location.href='adm3.php'">Salvar</button>
        </form>
    </div>
</body>
</html>
