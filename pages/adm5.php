        ...
        <section class="content">
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                            <th><img class="icon" src="../img/icon_user.png" alt="Usuário">Nome</th>
                            <th><img class="icon" src="../img/email.png" alt="Email">Email</th>
                            <th><img class="icon" src="../img/mensagem.png" alt="Mensagem">Mensagem</th>
                            <th>Ações</th>
                        </tr>
                    </thead>
                    <tbody>
