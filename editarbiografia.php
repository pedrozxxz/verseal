...
<body>
  ...
  <div class="foto-area">
    <img src="../img/jamile.jpg" alt="Foto da artista">
  ...
  <form action="" method="post">
    ...
    <textarea name="descricao" rows="3" placeholder="Digite..."></textarea>

    <label>Data de nascimento</label>
    <input type="date" name="data_nascimento">

    <label>Telefone</label>
    <input type="tel" name="telefone" placeholder="Digite...">
    ...
    <div class="duo">
      ...
      <div>
        ...
        <input type="text" name="social" placeholder="Digite...">
      </div>
    </div>
  </form>
</div>
